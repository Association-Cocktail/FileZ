    ...
    <header>
      <h1>
        <?php if (fz_config_get ('looknfeel', 'your_logo', '') != ''): ?>
          <span id="your-logo">
			  <a href="<?php echo public_url_for ('/') ?>" id="filez-logo" title="<?php echo __('Home') ?>">
		...
		<!--center style="color:#FF0000">Ecrire ici un message d'alerte !</br>Merci de nous remonter toute anomalie constatée ("Signaler un bogue" ci-dessous).</center-->
